      ...
      <div className="flex-1 flex flex-col bg-background relative overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-6 py-8">
          <div className="w-full max-w-[400px]">
            ...
            <div className="mb-8">
              <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-1.5">Create your account</h1>
              <p className="text-muted-foreground text-sm">Join ReelCast and start publishing smarter</p>
            </div>
            ...
            <form onSubmit={handleEmailSignUp} className="space-y-4">
              ...
              <p className="text-center text-xs text-muted-foreground">
                ...
                <Link href={"/terms" as Route} className="underline underline-offset-3 hover:text-foreground">
                  Terms
                </Link>{" "}
                and{" "}
                <Link href={"/privacy" as Route} className="underline underline-offset-3 hover:text-foreground">
                  Privacy Policy
                </Link>
              </p>
            </form>
