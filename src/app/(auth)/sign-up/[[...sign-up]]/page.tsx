      ...
      <div className="relative z-10 w-full max-w-sm mx-auto">
        <div className="flex flex-col items-center mb-10 space-y-4">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-muted-foreground text-sm px-6">
              Create your account to start generating AI YouTube content.
            </p>
          </div>
        </div>
        ...
        <div className="bg-card border border-border/60 rounded-3xl p-8 shadow-2xl backdrop-blur-md relative">
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-max z-20">
            <div className="bg-secondary text-secondary-foreground text-xs font-bold px-4 py-1.5 rounded-full shadow-lg flex items-center gap-1.5 border border-border">
              <Sparkles className="w-3.5 h-3.5" /> Get ready for the magic.
            </div>
          </div>
